          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>Title</th> <th>Body</th> <th>User_id</th> <th>Last_reply_user_id</th> <th>Order</th> <th>Excerpt</th> <th>Slug</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$topic->title}}</td> <td>{{$topic->body}}</td> <td>{{$topic->user_id}}</td> <td>{{$topic->last_reply_user_id}}</td> <td>{{$topic->order}}</td> <td>{{$topic->excerpt}}</td> <td>{{$topic->slug}}</td>
